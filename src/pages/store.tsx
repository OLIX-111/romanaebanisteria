    ...
    <main className={`${openSans.className} bg-white pt-20`}>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10 pt-6">
          ...
          >
            <div
              className="flex w-full gap-2 rounded-md shadow-sm p-[.3rem] bg-gray-300/50 border border-black/5 duration-200 mb-4"
              role="group"
            >
              <button
                type="button"
                className={`px-4 text-sm w-1/2 py-2 font-medium rounded-md ${
                  viewMode === "products" ? "bg-white text-black" : "text-gray-700 hover:bg-gray-50"
                }`}
              ...
              <button
                type="button"
                className={`px-4 text-sm w-1/2 py-2 font-medium rounded-md ${
                  viewMode === "services" ? "bg-white text-black" : "text-gray-700 hover:bg-gray-50"
                }`}
