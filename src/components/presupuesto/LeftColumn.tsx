...
export default function LeftColumn({ search, setSearch, filteredProducts, onAdd }: LeftColumnProps) {
  ...
  useEffect(() => {
    const entries = Object.keys(productsByCategory)
    if (entries.length && expandedCategories.size === 0) {
      setExpandedCategories(new Set([entries[0]]))
    }
  }, [productsByCategory])
                                            ...
                                            {attr.options.map((opt) => {
                                              ...
                                              return (
                                                <button
                                                  ...
                                                  className={`group relative rounded-md border overflow-hidden text-left focus:outline-none ${selected ? "border-primary ring-2 ring-primary/30" : "border-gray-200"
                                                    }`}
                                                >
                                                  ...
                                                  {opt.sub_options.map((sub) => {
                                                    ...
                                                    return (
                                                      <button
                                                        ...
                                                        className={`group relative rounded-md border overflow-hidden text-center focus:outline-none w-28 sm:w-32 ${selectedSub ? "border-primary ring-2 ring-primary/30" : "border-gray-200"
                                                          }`}
                                                      >
                                      ...
                                      return (
                                        <div className="flex items-center gap-3">
                                          ...
                                          <button
                                            ...
                                            disabled={!isComplete}
                                            className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-offset-2 border ${isComplete
